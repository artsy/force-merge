...
const basePackage = {
  ...
  "scripts": {
    ...
    "gitpush": "git add . && git add -f desktop && git add -f mobile && git commit -a -m 'deploying' && git push --force git@github.com:craigspaeth/force-merge.git",
    "deploy": "npm run assets && npm run bucket && npm run gitpush",
    "ci": "npm run merge && npm test && npm run deploy"
  },
  "license": "MIT",
}
